           ...
           <table class="table row justify-content-center table-responsive-md table table-striped rounded">
            <thead>
                <tr class="row justify-content-center text-center">
                    <th style="border-style: none">Update User Details</th>
                </tr>
            </thead>
            <tbody class="mt-3">
                <tr>
                ...
                <tr>
                    <td>photo</td>
                    <td><input type="file" name="photo" value="{{ asset($edits->photo) }}"><img src="{{ asset($edits->photo) }}" alt="png" id="photo" style="width: 200px;height: 200px;"></td>
                </tr>
                <tr>
